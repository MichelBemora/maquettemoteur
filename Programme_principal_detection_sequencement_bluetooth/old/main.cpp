...
unsigned long timer2_T = 0;
unsigned long timer3_T = 0;
unsigned long timer4_T = 0;
...
//=================================================================================
  ...
  if (top == 1) {
    ...
    timerAlarmWrite(timer1, timer1_T, true);
    timerAttachInterrupt(timer2, &onTimer2, true);
    timerAlarmWrite(timer2, timer2_T, true);
    timerAttachInterrupt(timer3, &onTimer3, true);
    timerAlarmWrite(timer3, timer3_T, true);
    timerAttachInterrupt(timer4, &onTimer4, true);
    timerAlarmWrite(timer4, timer4_T, true);
...
timer1_T = position_injection_T;
timer2_T = position_injection_T + T_ouverture_injection + T_injection_utile;
timer3_T = PMH - T_avance_bobine - T_charge_bobine;
timer4_T = PMH - T_avance_bobine;
...
//=========================================================================================================================
  ...
  //Serial.print("rpm  ");
//  Serial.println(timer1_T);
  //  Serial.println(timer2_T);
   //   Serial.println(timer3_T);
     //   Serial.println(timer4_T);
  //Serial.print("Cycle :  ");
